...
import { Plane, GraduationCap, Building, CheckCircle } from 'lucide-react';
...
export default function Home() {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      // SUCCESS → Show tick + Validated
      setValidated(true);

      /* ==========================================================
         IMPORTANT: Save access token in cookie for middleware
      =========================================================== */
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-center items-center gap-6 mb-12">
          <div className="w-20 h-20 bg-orange-600 hover:bg-orange-700 rounded-full flex items-center justify-center">
            <Plane className="w-10 h-10 text-white" />
          </div>
          <div className="w-20 h-20 bg-blue-600 hover:bg-blue-700 rounded-full flex items-center justify-center">
            <GraduationCap className="w-10 h-10 text-white" />
          </div>
          <div className="w-20 h-20 bg-green-600 hover:bg-green-700 rounded-full flex items-center justify-center">
