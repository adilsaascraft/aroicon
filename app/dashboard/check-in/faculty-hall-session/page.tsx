    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold mt-3">Faculty in Hall Check-In</h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {isLoading ? (
            ...
            filtered.map((m) => {
              ...
              const checkInTime =
                m.hallCheckInStatus && m.hallCheckInTime
              ...
              return (
                ...
                >
                  <CardContent>
                    ...
                    {/* SESSION DETAILS */}
                    <div className="space-y-2 mb-4 p-3 bg-purple-50 rounded-lg text-sm text-gray-700">
                      {m.topicName ? (
                        <>
