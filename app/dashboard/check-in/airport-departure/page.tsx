...
export default function AirportDeparturePage() {
  ...
  const openConfirm = (it: Item) => {
    if (it.departureCheckInStatus) return;
    setSelected(it);
    setShowConfirm(true);
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {isLoading ? (
            ...
            filtered.map((m) => {
              ...
              const checkInTime =
                m.departureCheckInStatus && m.updatedAt
              ...
              return (
                ...
                >
                  <CardContent>
                    ...
                    {/* DEPARTURE DETAILS */}
                    <div className="space-y-2 mb-4 p-3 bg-green-50 rounded-lg text-sm text-gray-700">
